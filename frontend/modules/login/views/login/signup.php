...
<div class="site51_form_col10_dangnhap">
                ...
                <div class="main__left--register">
                    <div class="nav-tab">
                        <div class="flex-text-tab">
                            ...
                            <a href="<?= Url::to(['/login/login/signupdoanhnghiep'])?>">Doanh nghiệp</a>
                        </div>
                        <div class="Tab active">
                            ...
                            $form = ActiveForm::begin([
                                'id' => '',
                                'options' => [
                                    'class' => 'register__user'
                                ]
                            ]);
                            ?>
                            <?=
                            $form->field($model, 'username', [
                                'template' => '<label for=""><i class="far fa-user"></i>{input}{error}</label>'
                            ])->textInput([
                                'class' => 'content_16',
                            ...
                            $form->field($model, 'type', [
                                ...
                                'type' => 'hidden',
                                'value' => \frontend\models\User::TYPE_CA_NHAN,
                            ]);
                            ?>
                            <?= $form->field($model, 'terms_and_condition')
                                ->radio([
                                    ...
                                    'value' => 1,
                                    'uncheck' => null,
                                    'style' => 'float:left;margin-right:15px;width: auto;height: auto;margin-bottom: 0;'
                            ]) ?>
                        ...
                        <div class="Tab">
                            ...
                            <?=
                            $form->field($model, 'username', [
                                'template' => '<label for=""><i class="far fa-building"></i>{input}{error}</label>'
                            ])->textInput([
                                'class' => 'content_16',
                            ...
                            <?= $form->field($model, 'terms_and_condition')
                                ->radio([
                                    'label' => 'Đồng ý điều khoản & chính sách của Meter',
                                    'value' => 1,
                                    'uncheck' => null,
    ...
    margin-bottom: 0;'
                            ...
                            <button class="btn-animation content_16">Đăng ký</button>
                            <?php ActiveForm::end(); ?>
                        </div>
                    </div>
                </div>
