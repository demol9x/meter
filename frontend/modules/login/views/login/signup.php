                            ...
                            <div class="box-account">
                                <div class="bg-pop-white">
                                    ...
                                    <div class="form-group passwordre">
                                        <input type="password" id="passwordre" class="form-control" name="passwordre" placeholder="<?= Yii::t('app', 'signup_gca_text_2')  ?>" aria-required="true" aria-invalid="true">
                                    ...
                                    <p class="center">
                                        <?= Yii::t('app', 'signup_gca_text_8') ?> <a class="open-popup-link" href="#login-box-popup"><?= Yii::t('app', 'signup_gca_text_9') ?></a>
                                    </p>
                                    <?php ActiveForm::end(); ?>
                                </div>
                            </div>
