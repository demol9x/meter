...
$this->title = 'Thông kê thưởng giới thiệu sản phẩm';
                                        ...
                                        <tr>
                                            ...
                                            <td class="" style="width:50%;">
                                                <div class="t-report t-cvr h3 push-5"><span
                                                            id="cr-order-convert"><?= number_format($rate, 0, ',', '.') ?>
                                                        %</span>
                                                </div>
                                        ...
                                        <tr>
                                            <td class="border-r">
                                                <div class="t-report t-tran-success h3 push-5" id="">
                                                    <span
                                                            id="valid-conversion-payout-value"><?= number_format($commission[Order::ORDER_DELIVERING], 0, ',', '.') ?></span><sup><?= __VOUCHER_RED ?></sup>
                                                </div>
                                                <div class="h6 text-muted text-uppercase push-5-t">Thành công</div>
                                            </td>
                                            <td class="border-r">
                                                <div class="t-report t-tran-pending h3 push-5" id=""><span
                                                            id="pending-conversion-payout-value"><?= number_format($commission[Order::ORDER_WAITING_PROCESS], 0, ',', '.') ?></span><sup><?= __VOUCHER_RED ?></sup>
                                                </div>
                                                <div class="h6 text-muted text-uppercase push-5-t">Chờ duyệt</div>
                                            </td>
                                            <td>
                                                <div class="t-report t-tran-cancel h3 push-5" id=""><span
                                                            id="invalid-conversion-payout-value"><?= number_format($commission[Order::ORDER_CANCEL], 0, ',', '.') ?></span><sup><?= __VOUCHER_RED ?></sup>
                                                </div>
                                                <div class="h6 text-muted text-uppercase push-5-t">Hủy</div>
                                            </td>
                                        </tr>
                                    ...
                                    <div id="table-conversion-list_wrapper"
                                        ...
                                        <table class="table table-striped table-vcenter table-hover dataTable no-footer" id="table-conversion-list" role="grid" aria-describedby="table-conversion-list_info">
                                            ...
                                            <tr role="row">
                                                ...
                                                <!-- <th class="hidden-sm hidden-md hidden-xs sorting_disabled" rowspan="1"
                                                    colspan="1"
                                                ...
                                                foreach ($orderItems as $item) {
                                                    ...
                                                    <tr role="row" class="filter">
                                                       ...
                                                       <!--  <td class="hidden-sm hidden-md hidden-xs" rowspan="1" colspan="1">
                                                           <?php //echo date('d-m-Y H:i', $item['click_time']) ?>
                                                        </td> -->
                                                        ...
                                                        <td rowspan="1" colspan="1">
                                                            <?= number_format($item['sale_before_product'], 0, ',', '.') ?> V
                                                        </td>
                                                        <td>
                                                            <?= $item['order_id'] ?>
                                                        </td>
