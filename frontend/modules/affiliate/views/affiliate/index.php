...
<div class="form-create-store">
    ...
    <div class="nav-donhang">
        <ul class="tab-menu">
            <li class="active">
                <a href="javascript:void(0)" style="text-transform: uppercase"><?= Yii::t('app', 'all_product') ?></a>
            </li>
            <li class="">
                <a href="<?= Url::to(['/profile/affiliate/index-design']) ?>" style="text-transform: uppercase"><?= Yii::t('app', 'product_design') ?></a>
            </li>
        </ul>
    </div>
