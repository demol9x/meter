        ...
        <div class="item_left">
            <div class="menu-my-store">
                <div class="banner-store" id="avatar_img_avatar1">
                    ...
                    <?php } ?>
                    <a class="fix-img-bg content_13" id="usercover_form" type="submit">
                        <i class="fa fa-camera" aria-hidden="true"></i>Thay đổi ảnh bìa</a>
                </div>
                <script type="text/javascript">
                ...
                <div class="menu-bar-store" tabindex="-1">
                    <div class="menu-bar-lv-1">
                        <a class="a-lv-1 content_14" href="<?= Url::to(['/management/order/index']) ?>">
                            <img src="<?= yii::$app->homeUrl ?>images/icon-menu3.png" alt="">Kiểm tra đơn hàng</a>
                        <div class="menu-bar-lv-2">
                            <a class="a-lv-2 content_14" href="<?= Url::to(['/management/order/index']) ?>">
                                Danh sách đơn hàng</a>
                        </div>
                        <?php if (isset($shop) && $shop) { ?>
                            <div class="menu-bar-lv-2">
                                <a class="a-lv-2 content_14" href="<?= Url::to(['/management/package/order']) ?>">
                                    Gói thầu chào bán</a>
                            </div>
                        <?php } ?>
                    ...
                    <?php if (isset($shop) && $shop) { ?>
                        <div class="menu-bar-lv-1">
                            <a class="a-lv-1 content_14" href="<?= Url::to(['/management/packageorder/index']) ?>">
                                <img src="<?= yii::$app->homeUrl ?>images/bell-notify.png" alt="">Đang dự thầu<i class="count-notinfycation content_14"></i>
                            </a>
                        </div>
                    <?php } ?>
                    <?php if (isset($shop) && $shop) { ?>
                    ...
                    <?php } ?>
                    <div class="menu-bar-lv-1">
                        <a class="a-lv-1 content_14" href="<?= Url::to(['/management/profile/index']) ?>"><img src="<?= yii::$app->homeUrl ?>images/icon-menu2.png" alt="">Hồ sơ cá nhân</a>
                        <div class="menu-bar-lv-2">
                            <a class="a-lv-2 content_14" href="<?= Url::to(['/management/profile/change-profile']) ?>">
                                Thay đổi thông tin cá nhân</a>
                        </div>
                        <div class="menu-bar-lv-2">
                            <a class="a-lv-2 content_14" href="<?= Url::to(['/management/profile/address']) ?>">
                                Địa chỉ</a>
                        </div>

                        <div class="menu-bar-lv-2"><a class="a-lv-2 content_14" href="<?= Url::to(['/management/profile/update-password']) ?>">
                                Đổi mật khẩu</a></div>
                        <span class="span-lv-1 fa fa-angle-down"></span>
                    </div>
                    <div class="menu-bar-lv-1">
                        ...
                        ?>
                            <a class="content_14" href="<?= Url::to(['/management/tho/index']) ?>">
                                <img src="<?= yii::$app->homeUrl ?>images/ico-menu7.png" alt="">Đăng ký làm thợ</a>
                        <?php
                        } else if (isset($user->type) && $user->type == User::TYPE_DOANH_NGHIEP) {
                        ?>
                            <a class="content_14" href="<?= Url::to(['/management/shop/index']) ?>">
                                <img src="<?= yii::$app->homeUrl ?>images/ico-menu7.png" alt="">Quản trị doanh
                                nghiệp</a>
                    ...
                    <div class="menu-bar-lv-1">
                        <a class="content_14" href="<?= Url::to(['/login/login/logout']) ?>">
                            <i class="fas fa-sign-out-alt" style="font-size: 23px; color: dimgrey; margin-right: 18px;"></i>
                            Đăng xuất
                        </a>
                    </div>
