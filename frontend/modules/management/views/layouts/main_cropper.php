                            ...
                            <?php if($shop->id) { ?>
		                        <div class="menu-bar-store" tabindex="-1">
		                            <div class="menu-bar-lv-1">
	                                    ...
	                                    <div class="menu-bar-lv-2"><a class="a-lv-2" href="<?= Url::to(['/management/gcacoin/index']) ?>">Ví OCOP V</a></div>
		                                <span class="span-lv-1 fa fa-angle-down"></span>
		                            </div>
		                            <div class="menu-bar-lv-1">
		                                <a class="a-lv-1" href="<?= Url::to(['/management/product/index']) ?>"><img src="<?= Yii::$app->homeUrl ?>images/ico-menu6.png" alt=""><?= Yii::t('app', 'product_management') ?> </a>
		                            </div>
		                            <div class="menu-bar-lv-1">
		                                <a class="a-lv-1" href="<?= Url::to(['/management/order/index']) ?>"><img src="<?= Yii::$app->homeUrl ?>images/icon-menu3.png" alt=""><?= Yii::t('app', 'order_management') ?> </a>
		                            </div>
		                            <!-- <div class="menu-bar-lv-1">
		                                <a class="a-lv-1" href="<?= Url::to(['/management/message/index']) ?>"><img src="<?= Yii::$app->homeUrl ?>images/ico-menu5.png" alt=""><?= Yii::t('app', 'message') ?> </a>
		                            </div> -->
		                            <div class="menu-bar-lv-1"><a href="<?= Url::to(['/management/profile/index']) ?>"><img src="<?= Yii::$app->homeUrl ?>images/icon-menu2.png" alt=""><?= Yii::t('app', 'user_file') ?></a></div>
		                        </div>
	                        <?php } ?>
	                    </div>
	                </div>
