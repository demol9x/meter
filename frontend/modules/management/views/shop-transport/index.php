               ...
               <?php if($shop_transports){
                    foreach ($shop_transports as $shop_transport) {  ?>
                        <li>
                            ...
                            <div class="col-right">
                                <div class="check-active">
                                    <input <?= $shop_transport['default'] ? 'checked' : '' ?> type="checkbox" class="ios8-switch ios8-switch-small change-bg save-defaut" data-check="<?= $shop_transport['default'] ? '1' : '0' ?>" data-id="<?= $shop_transport['transport_id'] ?>" id="checkbox-df-<?= $shop_transport['transport_id'] ?>">
                    ...
                    foreach ($transports as $transport) {  
                        if(!in_array($transport['id'], $act)){
                            ...
                            <li>
                                ...
                                <div class="col-right">
                                    <div class="check-active">
                                        <input  type="checkbox" class="ios8-switch ios8-switch-small change-bg save-defaut" data-check="0" data-id="<?= $transport['id'] ?>" id="checkbox-df-<?= $transport['id'] ?>">
