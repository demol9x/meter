...
$this->params['breadcrumbs'][] = ['label' => $model->name, 'url' => Url::to(['/shop/shop/detail', 'id' => $model->id, 'alias' => $model->alias])];
...
<div class="form-create-store">
    <div class="title-form">
        ...
        <?php } ?>
        <?= $model->status == 2 ? '<div class="alert">Gian hàng quý khách đang chờ được duyệt. Vui lòng đợi tối đa là 24h.</div>' : '' ?>
    ...
    <div class="table-buyer table-shop">
        <table>
            <tbody>
                ...
                <tr>
                    <td>
                        <label for="">Loại tài khoản gian hàng</label>
                    </td>
                    <td>
                        <p><?= $model->getNameTypeAcount() ?></p>
                        <div class="form-fixed" id="shopsshop_acount_type">
                            <?php $tp = \common\models\shop\Shop::getOptionsTypeAcount(); ?>
                            <select class="input_text" name="shop_acount_type">
                                <?php foreach ($tp as $id => $value) { ?>
                                    <option value="<?= $id ?>" <?= $model->shop_acount_type == $id ? 'selected' : '' ?>><?= $value ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </td>
                    <td width="170" class="txt-right">
                        <a data="#shopsshop_acount_type" class="open-fixed"><i class="fa fa-pencil"></i><?= Yii::t('app', 'change') ?></a>
                        <div class="form-fixed">
                            <a class="save-shop"><i class="fa fa-check"></i><?= Yii::t('app', 'save') ?></a>
                            <a class="cance" href="javascript:void(0);"><i class="fa fa-times"></i><?= Yii::t('app', 'cancer') ?></a>
                        </div>
                    ...
                    if (data == '1') {
                        switch (attr) {
                            ...
                            case 'sex':
                                ...
                                break;
                            case 'shop_acount_type':
                                if (value == '1') {
                                    label.html('Nhà sản xuất');
                                } else {
                                    label.html('Nhà phân phối');
                                }
                                break;
                            default:
                                label.html(value);
