...
<?php $form = ActiveFormC::begin(); ?>
    ...
    <?= $form->fields($model, 'email')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->fields($model, 'address')->textInput(['maxlength' => true, 'id'=>'pac-input-uadd']) ?>
    <div class="form-group field-user-name required has-success">
        <div class="item-input-form">
            <label class="" for="user-name">
            </label>
            <div class="group-input">
                <div class="full-input">
                    <div class="box-map">
                        <?php $latlng = $model->latlng ? $model->latlng : '21.03139,105.8525' ?>
                        <input type="hidden" name="UserAddress[latlng]" id="latlng" value="<?=  $model->latlng ?>">    
                        ...
                        <!-- start map -->
                            <script type="text/javascript">
                                function generateAddress() {
                                    ...
                                    var street_id = $('#pac-input-uadd').val();
                                    var street_name = $('#pac-input-uadd').val();
                                    var street_prefix = '';
                                ...
                                $(document).ready(function () {
                                    ...
                                    // Chọn đường phố
                                    $('#pac-input-uadd').change(function () {
                                        generateAddress();
                                    });
                                });
                            </script>
