...
<?php if($orders) foreach ($orders as $order) { 
    ...
    ?>
    <div class="item-info-donhang" id="box-b4-<?= $order['id'] ?>">
        <div class="title">
            <div class="img">
                <a href="<?= $s_url ?>">
        ...
        <div class="title bottom-item-info-donhang">
            ...
            <div class="code-donhang">
                <!-- <?php if(time() < ($order['updated_at'] + 60*60*24*3) && !$order['transport_id']) { ?>
                    <a class="click cancer" onclick="returnoder(<?= $order['id'] ?>, 4)"><?= Yii::t('app', 'order_check_100') ?></a>
                <?php } ?> -->
