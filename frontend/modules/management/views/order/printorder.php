...
<div id="wrap-print-order-border" style="padding: 15px;">
    ...
    <div class="col-xs-5" style="text-align: center;">
        ...
        <p>vào lúc : phút ...giờ ...Ngày ...tháng...năm.....</p>
    ...
    <div class="col-xs-12">
        <p><b>Mã đơn hàng</b>: OR<?= $model->id ?>( <?= $model->payment_status == \common\components\payments\ClaPayment::PAYMENT_STATUS_SUCCESS ? "Đã thanh toán " : "Chưa thanh toán " ?> bằng <?= \common\components\payments\ClaPayment::getName($model['payment_method']) ?>)</p>
    </div>
    ...
    <p class="pull-right text-result">
        ...
        <b style="color: red"><?= ($model->shipfee > 0) ? number_format($model->shipfee, 0, ',', '.') . ' đ' : 'Miễn phí' ?></b>
    </p>
    <div class="clearfix"></div>
    <p class="pull-right text-result">
        <i class="fa fa-money" style="width: 15px;"></i>
