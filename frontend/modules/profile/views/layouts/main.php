            ...
            <div class="menu-my-store">
                ...
                <div class="menu-bar-store" tabindex="-1">
                    ...
                    <?php if (isset($user) && $user->type == 2) { ?>
                        <div class="menu-bar-lv-1">
                            <a class="a-lv-1 content_14" href="<?= Url::to(['/profile/profile/add-goithau']) ?>">
                    ...
                    <div class="menu-bar-lv-1">
                        ...
                        <div class="menu-bar-lv-2"><a class="a-lv-2 content_14" href="<?= Url::to(['/profile/profile/update-password']) ?>">Đổi
                                mật khẩu</a></div>
                    ...
                    <div class="menu-bar-lv-1">
                        ...
                        <?php
                        } else if ($user->type == User::TYPE_DOANH_NGHIEP) {
                        ?>
                            <a class="content_14" href="<?= Url::to(['/profile/profile/profile-nhathau']) ?>"><img src="<?= yii::$app->homeUrl ?>images/ico-menu7.png" alt="">Quản trị doanh nghiệp</a>
                        <?php } else if ($user->type == User::TYPE_THO) {
                        ?>
                            <a class="content_14" href="<?= Url::to(['/profile/profile/add-tho']) ?>">
