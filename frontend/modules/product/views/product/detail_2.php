...
<script type="text/javascript">
    ...
    function loadImgQR() {
        ...
        loadAjaxPost('<?= Url::to(['/product/product/get-qr']) ?>', {product_id: product_id, quantity: quantity, tranport_type: tranport_type, shipfee: shipfee, province : province, district : district, address_id_from:address_id_from}, $('#img-qr'));
    }
</script>
                        ...
                        <div class="option-product-detail">
                            ...
                            <div class="addcart-detail-product">
                                <script type="text/javascript">
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        $('#add-cart-ajax').click(function () {
                                            ...
                                            loadAjax(href, {ajax : 1}, $('#box-shopping-cart'));
                                            return false;
                                        });
                                ...
                                <?php if (Yii::$app->user->getId()) { 
                                    $check = \frontend\components\Shoppingcart::check($model->code . $model->id);
                                    ?>
                                    <a class="btn-style-1 click" id="add-cart-ajax" add="<?= $check ? '0' : 1 ?>" ><i class="fa fa-shopping-cart"></i><?= $check ? Yii::t('app', 'added_shoppingcart') : Yii::t('app', 'add_to_bag') ?></a>
                                ...
                                <?php } else { ?>
                                    <a class="btn-style-1 open-popup-link" href="#login-box-popup"><i class="fa fa-shopping-cart"></i><?= Yii::t('app', 'add_to_bag') ?></a>
