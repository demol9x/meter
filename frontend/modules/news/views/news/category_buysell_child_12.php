...
if ($account_status) {
    $list_rn = \common\models\form\FormRegisterSell::getListRegisted($user_id);
}
?>
                                    ...
                                    <div class="box-info">
                                        ...
                                        <div class="date-news2">
                                            ...
                                            <div class="right-social-box">
                                                <span data-user_id="<?= $news['id'] ?>" data-note="<?= $rged ? '1' : '0' ?>" href="<?= $account_status ? ' #form-sell'  : ' #form-note' ?>" class="regiter-bs open-popup-link register_sell"><?= $rged ? 'Đăng ký lại' : 'Đăng ký' ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
