                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="infor-news-detail">
                        ...
                        <p class="time-news">
                            ...
                            <span data-user_id="<?= $model['id'] ?>" data-note="<?= $check ? '1' : '0' ?>" href="<?= $account_status ? ' #form-sell'  : ' #form-note' ?>" class="regiter-bs open-popup-link register_sell"><?= $check ? 'Đăng ký lại' : 'Đăng ký' ?></span>
                        </p>
                        <hr>
