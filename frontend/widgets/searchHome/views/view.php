...
$image_background = \common\models\banner\Banner::find()->where(['group_id' => 17])->one();
    ...
    <section class="section-product-filter">
        <div class="container">
            <div class="section-filter"
                style="background-image: url('<?php echo $image_background->src ?>');padding: unset">
                ...
                <div class="filter-tabs-body" style="background: rgba(0,0,0,0.4);padding: 0 3rem 0 3rem;">
                    <?php foreach($data as $key => $bds) {
                        echo $this->render('form', array(
                            ...
                            'bds' => $bds,
                            'provinces' => $provinces,
                            'huong_nha_select' => $huong_nha_select,
                            'dien_tich' => $dien_tich,
                        ));
                     } ?>
                </div>
