    ...
    <div class="pro_flex">
        ...
        foreach ($package as $packages) {
            ...
            <div class="pro_card wow fadeIn" data-wow-delay="0.3s">
                <a href="<?= $url ?>">
                    <div class="card_img">
                        <img src="<?= ClaHost::getImageHost(), $packages['avatar_path'], $packages['avatar_name'] ?>"
                             alt="<?= $packages['name'] ?>">
                    </div>
                    <div class="card_text">
                        ...
                        <div class="date_time">
                            <img src="<?= Yii::$app->homeUrl ?>images/time_pro.png" alt=""><span><?= date('d', $packages['created_at']) ?></span>-<span><?= date('m', $packages['created_at']) ?></span>-<span><?= date('Y', $packages['created_at']) ?></span>
                        </div>
                    </div>
                </a>
                <label class="heart">
                    ...
                    <div class="check">
                        <span class="iuthik1 active"><img class="img_add_tim"
                                                          src="<?= Yii::$app->homeUrl ?>images/tim.png" alt=""></span>
