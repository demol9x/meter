            ...
            <div class="fitler croll">
                ...
                <div>
                    <a class="p_provin" href="javascript:void(0)" data-param="p">
                        <input type="radio" id="<?= $value['id']  ?>" name="check_pack" value="<?= $value['id']  ?>" <?= (in_array($value['id'],$arr_p)) ? 'checked' : ''?>>
        ...
        <div class="pro_fitler">
            ...
            <div class="fitler">
                <div class="fitler_flex">
                    <div>
                        <input type="radio" id="10-50" name="check_package" value="10-50">
                ...
                <div class="fitler_flex">
                    <div>
                        <input type="radio" id="60-100" name="check_package" value="60-100">
