                        ...
                        <?php if ($listMap) foreach ($listMap as $product) {
                            ...
                            if (count($tg) > 1) {
                                ...
                                if (!$product['price_range']) {
                                    $text_price .= ($product['price_market'] > $product['price'] && $product['price_market'] > 0) ? '<del>' . number_format($product['price_market'], 0, ',', '.') . '</del>' : '';
                                    $text_price .= ($product['price'] > 0) ? number_format($product['price'], 0, ',', '.') . ' ' . Yii::t('app', 'currency') : Yii::t('app', 'contact');
                                } else {
