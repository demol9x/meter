            ...
            <ul>    <!-- SLIDE  -->
                <?php foreach ($data as $banner) { ?>
                    <li data-transition="fadetobottomfadefromtop" data-slotamount="7" data-masterspeed="1500">
                        <!-- MAIN IMAGE -->
                        <img data-lazyload="<?php echo $banner['src']; ?>"
                             src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                             alt="<?= Trans($banner['name'],$banner['name_en']) ?>" data-bgfit="cover" data-bgposition="top center"
                        ...
                        <div class="tp-caption medium_bg_orange skewfromleftshort customout"
                             ...
                             style="z-index: 21"><?= Trans($banner['description'],$banner['description_en']) ?>
                        </div>
                    </li>
                <?php } ?>
            </ul>
