                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($prqlt < $price_range[$i]) { ?>
                                                        <p class="red">
                                                            <?= $model->getPriceText($quality_range[$i]); ?> <?= Yii::t('app', 'currency') ?>
                                                            <span><?= number_format($price_range[$i], 0, ',', '.'); ?></span>
                                                        </p>
                                                    <?php } else { ?>
                                                        <p class="red"><?= $model->getPriceText($quality_range[$i]); ?> <?= Yii::t('app', 'currency') ?></p>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                        ...
                        <?php if ($model->status_quantity && $price > 0) { ?>
                            ...
                            <div class="option-product-detail">
                                ...
                                <div class="addcart-detail-product">
                                    <script type="text/javascript">
                                        ...
                                        $(document).ready(function() {
                                            ...
                                            $('#add-cart-href').click(function() {
                                                $('#add-cart-href').attr('href', '<?= Url::to(['/product/shoppingcartv/index', 'id' => $model['id'], 'quantity' => '']) ?>' + $('#qty').val());
                                            });
                                    ...
                                    <a class="chat-buyer btn-style-1" id="add-cart-href" href="<?= Url::to(['/product/shoppingcartv/index', 'id' => $model['id']]) ?>"><i class="fa fa-check"></i><?= Yii::t('app', 'buy_now') ?></a>
                                    <?php
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="infor-buyer-store">
                        ...
                        <div class="share" style="padding: 26px 0px 0px 0px; clear: both;">
                            ...
                            ?>
                            <?php if ($model->status_affiliate && $model->affiliate_gt_product > 0 && Yii::$app->user->id) { ?>
