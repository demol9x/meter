...
?>
<div id="main">
    <div class="shopping-cart-page" style="text-align: center;">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if(isset($src) && $src) { ?>
                                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                    <img atl="mã qr" src="<?= $src  ?>">
                                                    <p style="clear: both; color: red;">Vui lòng sử dụng mã QR ở trên để thanh toán cho đơn hàng.</p>
                                                </div>
                                            <?php } ?>
                                        </div>
