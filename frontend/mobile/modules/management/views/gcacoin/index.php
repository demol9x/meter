...
<div class="form-create-store">
    ...
    <div class="row" style="padding: 15px 25px;">
        <div class="col-md-4"><label>Số dư V</label></div>
        <div class="col-md-4"><?= (isset($coin) && $coin) ? formatCoin($coin->getCoin()) : 0  ?> (V)</div>
    ...
    <div class="row" style="padding: 15px 25px;">
        <div class="col-md-4"><label>Số dư Vr khả dụng</label></div>
        <div class="col-md-4"><?= formatCoin($coin->getCoinRed() - $coin_waning)  ?> (Vr)</div>
    </div>
    <?php if ($coin_waning > 0) { ?>
        <div class="row" style="padding: 15px 25px;">
            <div class="col-md-4"><label>Số Vr đang chờ rút</label></div>
            <div class="col-md-4"><?= formatCoin($coin_waning)  ?> (Vr)</div>
        </div>
    <?php } ?>
    <div class="row" style="padding: 15px 25px;">
        <div class="col-md-4"><label>Số Vr tạm khóa</label></div>
        <div class="col-md-4"><?= formatCoin(\common\models\gcacoin\CoinConfinement::getCoinConfinement(Yii::$app->user->id))  ?> (Vr)</div>
        <div class="col-md-4" style="text-align: right">
