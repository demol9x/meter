...
$svn = str_replace('admin.', '', $svn);
$servermethod = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') ? 'https://' . $svn : 'http://' . $svn;
$_baseUrl = '/data/media/';
...
/*
  ...
  ATTENTION: The trailing slash is required.
 */
$baseDir = str_replace('/backend/www', '/frontend/www', resolveUrl($_baseUrl));
