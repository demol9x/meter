...
class Result extends CComponent {
...
class MobiCard extends CComponent {
    ...
    function CardPay($pin_card, $card_serial, $type_card, $_order_id, $client_fullname, $client_mobile, $client_email) {
        $params = array(
            ...
            'merchant_id' => NganluongConfig::MERCHANT_ID,
            'merchant_account' => NganluongConfig::RECEIVER,
            'merchant_password' => MD5(NganluongConfig::MERCHANT_ID . '|' . NganluongConfig::MERCHANT_PASS),
            'pin_card' => $pin_card,
    ...
    function CardPayWebservice($pin_card, $card_serial, $type_card, $ref_code, $client_fullname, $client_mobile, $client_email) {
        ...
        $strparams = $pin_card . '|' . $type_card . '|' . $ref_code . '|' . NganluongConfig::RECEIVER . '|' . $client_fullname . '|' . $client_email . '|' . $client_mobile . '|' . $card_serial;

        $params = array(
            'merchant_id' => NganluongConfig::MERCHANT_ID,
            'checksum' => MD5($strparams . '|' . NganluongConfig::MERCHANT_PASS),
            'params' => $strparams
        );
