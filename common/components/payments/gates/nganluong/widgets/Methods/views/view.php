<div class="payment-method">
    <div class="col-xs-12 payment">
        <ul class="list-content">
            ...
            <li class="">
                <label><input type="radio" value="<?php echo \common\components\payments\ClaPayment::PAYMENT_METHOD_MEMBER; ?>" name="Order[payment_method]" ><?= Yii::t('app', 'member_method') ?></label>
            </li>
            <li>
                <label>
