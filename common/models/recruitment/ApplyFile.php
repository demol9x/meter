...
/**
 * This is the model class for table "apply_file".
 *
 * @property string $id
 ...
 */
class ApplyFile extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
//            [['apply_id', 'display_name', 'name', 'path', 'extension'], 'required'],
            [['apply_id', 'size'], 'integer'],
            [['display_name', 'name', 'path', 'extension'], 'string', 'max' => 255],
        ];
    }
