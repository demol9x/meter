    ...
    <div class="col-md-10 district_select">
        <select data-placeholder="Chọn quận/ huyện" class="district-select" tabindex="5">
            <?php foreach ($districts as $key => $district): ?>
                <option value="<?= $key ?>" <?= $key == $model->district_id ? 'selected' : '' ?> ><?= $district ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-10 ward_select">
        <select data-placeholder="Chọn phường/ xã" class="ward-select" tabindex="5">
            <?php foreach ($wards as $key => $ward): ?>
                <option value="<?= $key ?>" <?= $key == $model->ward_id ? 'selected' : '' ?> ><?= $ward ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
