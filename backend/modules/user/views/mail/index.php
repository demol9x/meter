    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="box-mail">
                    <form action="" id="form-send" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                             <div class="col-sm-10 col-sm-offset-0">
                                ...
                                <a type="submit" name="sendMail" class="btn btn-primary updateajax">Gửi</a>
                             </div>
                         </div>
                    </form>             
                </div>
...
<script type="text/javascript">
    jQuery('.updateajax').on('click', function() {
            ...
            if($('#title').val() != '') {
                ...
                var href = '<?= Url::to(['/user/mail/send-mail', 'page' => 0]) ?>';
                $.ajax({
                    url: href,
                    type: 'POST',
