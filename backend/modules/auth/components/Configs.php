...
class Configs extends \yii\base\Object {
    ...
    const CACHE_TAG = 'backend.modules.auth';
     ...
     */
    public $menuTable = '{{%menu_admin}}';

    /**
     * @var string Menu table name.
     */
    public $userTable = '{{%user_admin}}';
    ...
    public static function instance() {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'backend.modules.auth.configs', []);
