...
<p>
   Có đơn hàng mới từ <?=__NAME_SITE?> với tổng giá trị đơn hàng là: <?= number_format($orderShop['order_total'], 0, ',', '.') ?> VNĐ
    <br/>
...
<p><a href="<?= __SERVER_NAME ?>/admin/order/order/index?OrderSearch[id]=<?= $orderShop['id'] ?>">Xem chi tiết</a></p>