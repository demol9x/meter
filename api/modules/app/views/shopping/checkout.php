                                                ...
                                                <div class="cart-tbody">
                                                    ...
                                                    <?php if ($shop->status_affiliate === \common\components\ClaLid::STATUS_ACTIVED && ($sale_buy_shop_coin ||  $sale_buy_shop_money)) { ?>
                                                        <div class="sale_aff">
                                                            <p>
                                                                <span>
                                                                    Thanh toán bằng <?=__NAME_SITE?> V giảm:
                                                                ...
                                                                <span> - </span>
                                                                <span>
                                                                    Thanh toán bằng hình thức khác <?=__NAME_SITE?> V tích lũy:
...
<script type="text/javascript">
    ...
    ?>
            $(document).ready(function() {
                confirmCS('Nạp tiền thành công.<br/> Tiếp tục thanh toán bằng <?=__NAME_SITE?> V?');
